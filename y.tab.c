...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from bibtex.y  */
...
const int YY_parse_CLASS::EQUALS=259;
...
const int YY_parse_CLASS::AT=265;
const int YY_parse_CLASS::JUNK=266;
const int YY_parse_CLASS::COMMENT=267;
const int YY_parse_CLASS::QUOTE=268;
const int YY_parse_CLASS::HASH=269;
const int YY_parse_CLASS::LPAREN=270;
const int YY_parse_CLASS::RPAREN=271;
const int YY_parse_CLASS::NEWLINE=272;
const int YY_parse_CLASS::ENDOFFILE=273;
...
static const short yyprhs[] = {     0,
     0,     2,     6,     9,    12,    20,    22,    24,    28,    30,
    36,    38,    40
};

static const short yyrhs[] = {    20,
     0,    21,    17,    20,     0,    21,    18,     0,    21,    17,
     0,    10,     3,     5,    22,     7,    23,     6,     0,     3,
     0,     9,     0,    24,     7,    23,     0,    24,     0,     3,
     4,     5,    25,     6,     0,     8,     0,     9,     0,     3,
     0
};
...
static const short yyrline[] = { 0,
    41,    43,    44,    45,    48,    51,    52,    54,    55,    57,
    59,    60,    61
};

static const char * const yytname[] = {   "$","error","$illegal.","NAME","EQUALS",
"LBRACE","RBRACE","COMMA","STRING","NUMBER","AT","JUNK","COMMENT","QUOTE","HASH",
"LPAREN","RPAREN","NEWLINE","ENDOFFILE","bibfile","entries","entry","key","fields",
"field","value",""
};
#endif
...
static const short yypact[] = {    -6,
     5,-32768,   -15,     4,    -6,-32768,    -2,-32768,-32768,-32768,
     3,     8,     9,     6,     7,    10,-32768,     8,    -3,-32768,
-32768,-32768,-32768,    11,-32768,    16,    18,-32768
};

static const short yypgoto[] = {-32768,
    14,-32768,-32768,     2,-32768,-32768
};
...
static const short yytable[] = {    21,
     9,     5,     6,     1,    22,    23,    10,     4,     7,    12,
    13,    17,    16,    18,    19,    27,    25,    28,     8,    20
};

static const short yycheck[] = {     3,
     3,    17,    18,    10,     8,     9,     9,     3,     5,     7,
     3,     6,     4,     7,     5,     0,     6,     0,     5,    18
};
...
case 5:
#line 48 "bibtex.y"
{/*insert into DB and clear string array*/insertIntoArray("bibkey",tempkey);
													insertIntoDB();clearString();;
    break;}
case 6:
#line 51 "bibtex.y"
{strcpy(tempkey,yyvsp[0].str);;
    break;}
case 7:
#line 52 "bibtex.y"
{strcpy(tempkey,yyvsp[0].str);;
...
case 10:
#line 57 "bibtex.y"
{printf("$1 is %s, tempval is %s\n",yyvsp[-4].str,tempval);insertIntoArray(yyvsp[-4].str,tempval);;
    break;}
case 11:
#line 59 "bibtex.y"
{printf("String in yacc, %s\n",yyvsp[0].str);strcpy(tempval,yyvsp[0].str);printf("Tempval :%s\n",tempval);;
    break;}
case 12:
#line 60 "bibtex.y"
{printf("Number in yacc %s\n",yyvsp[0].str);strcpy(tempval,yyvsp[0].str);printf("Tempval :%s\n",tempval);;
    break;}
case 13:
#line 61 "bibtex.y"
{printf("Name in yacc %s\n",yyvsp[0].str);strcpy(tempval,yyvsp[0].str);printf("Tempval :%s\n",tempval);;
    break;}
}
